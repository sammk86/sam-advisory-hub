...
describe('Resend Email Service Integration Tests', () => {
  ...
  describe('Email Sending Functionality', () => {
    ...
    it('should send confirmation email with user details', async () => {
      ...
      const emailData = {
        to: userData.email,
        subject: 'Account Confirmed - Welcome to MentorshipHub!',
    ...
    it('should send rejection email with reason', async () => {
      ...
      const emailData = {
        to: userData.email,
        subject: 'Account Review Update - MentorshipHub',
  ...
  describe('Email Template Rendering', () => {
    ...
    it('should handle template rendering with missing data', () => {
      ...
      expect(() => {
        const html = expect.stringContaining('MentorshipHub')
  ...
  describe('Email Template Validation', () => {
    ...
    it('should handle template variable substitution', () => {
      ...
      expect(rendered).toBe('Hello John Doe, welcome to MentorshipHub!')
    })
  })
