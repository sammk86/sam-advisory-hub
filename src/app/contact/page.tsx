...
import { FaEnvelope, FaLinkedin, FaTwitter, FaGithub, FaMapMarkerAlt, FaPhone } from 'react-icons/fa';
...
const ContactPage = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: 'Twitter',
      value: '@sammokhtari',
      link: 'https://twitter.com/sammokhtari'
    },
    {
      icon: FaGithub,
      title: 'GitHub',
      value: 'github.com/sammokhtari',
      link: 'https://github.com/sammokhtari'
    }
  ];
